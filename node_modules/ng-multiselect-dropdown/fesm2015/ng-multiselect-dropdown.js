...
let MultiSelectComponent = class MultiSelectComponent {
    ...
    itemShowRemaining() {
        return this.selectedItems.length - this._settings.itemsShowLimit + 1;
    }
    addSelected(item) {
        if (this._settings.singleSelection) {
            this.selectedItems = [];
