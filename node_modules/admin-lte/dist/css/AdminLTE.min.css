...
@media (min-width:768px) {
    ...
    .sidebar-mini.sidebar-collapse .sidebar-menu>li:not(.Child)>a>span {
        border-bottom-right-radius: 4px
    }
    ...
    .sidebar-mini.sidebar-collapse .sidebar-menu>li>a>span,
    .sidebar-mini.sidebar-collapse .sidebar-menu>li>.treeview-menu,
    .sidebar-mini.sidebar-collapse .sidebar-menu>li>ul>li>.Child-menu,
...
@media (min-width:768px) {
    ...
    .sidebar-mini:not(.sidebar-mini-expand-feature).sidebar-collapse .sidebar-menu>li>ul>li>:hover>.Child-menu {
        top: 44px;
        margin-left: 0
    }
}
...
.Child-menu>li>a>.fa,
.Child-menu>li>a>.glyphicon,
.Child-menu>li>a>.ion {
    width: 20px
}

.Child-menu>li>a>.pull-right-container>.fa-angle-left,
.Child-menu>li>a>.pull-right-container>.fa-angle-down,
.Child-menu>li>a>.fa-angle-left,
.Child-menu>li>a>.fa-angle-down {
    width: auto
}
...
.sidebar-menu .active>.Child-menu {
    display: block
}